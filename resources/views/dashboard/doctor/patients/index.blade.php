    ...
    <div class="flex-1 p-8">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('dashboard.doctor.patients.create') }}"
               class="bg-[#1d5e86] hover:bg-blue-800 text-white px-6 py-2 rounded-lg shadow transition">
                + Add Patient
            </a>
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-400">
                                No patients found.
                                <a href="{{ route('dashboard.doctor.patients.create') }}" class="text-blue-500 underline">Add a new patient</a>.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
