...
<div class="flex justify-center items-center min-h-screen bg-gray-100">
    <div class="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold mb-6 text-center" style="color: #1D5E86;">Enter Patient Credentials</h2>
        ...
        <form action="{{ route('dashboard.pharmacist.patient.search.submit') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <button type="submit" class="w-full bg-blue-800 text-white py-2 rounded-lg hover:bg-blue-900">
                Search
            </button>
        </form>
    </div>
