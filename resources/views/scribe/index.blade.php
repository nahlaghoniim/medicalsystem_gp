...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://medical-system.test";
        var useCsrf = Boolean();
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-GETapi-emergency--token-">
                                <a href="#endpoints-GETapi-emergency--token-">GET api/emergency/{token}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-patients--id-">DELETE api/patients/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-doctor-prescriptions">
                                <a href="#endpoints-GETapi-doctor-prescriptions">GET api/doctor/prescriptions</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-doctor-prescriptions--patientId-">
                                <a href="#endpoints-POSTapi-doctor-prescriptions--patientId-">POST api/doctor/prescriptions/{patientId}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-doctor-prescriptions--id-">
                                <a href="#endpoints-GETapi-doctor-prescriptions--id-">GET api/doctor/prescriptions/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-doctor-prescription-items--id-">
                                <a href="#endpoints-DELETEapi-doctor-prescription-items--id-">DELETE api/doctor/prescription-items/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-appointments--id-">DELETE api/appointments/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-patients--patientId--notes">
                                <a href="#endpoints-POSTapi-patients--patientId--notes">POST api/patients/{patientId}/notes</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-payments--id-">GET api/payments/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-medications-search">
                                <a href="#endpoints-GETapi-medications-search">GET api/medications/search</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-emergency--token-">GET api/emergency/{token}</h2>
...
<span id="example-requests-GETapi-emergency--token-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/emergency/consequatur" \
...
<div class="javascript-example">
    ...
    "https://medical-system.test/api/emergency/consequatur"
);
...
<span id="example-responses-GETapi-emergency--token-">
            <blockquote>
...
&lt;body&gt;
    &lt;div class=&quot;container&quot;&gt;
        ...
        &lt;!-- Display error message if available --&gt;
                    &lt;div class=&quot;card&quot;&gt;
                &lt;p&gt;Invalid or expired emergency token.&lt;/p&gt;
            &lt;/div&gt;
            &lt;/div&gt;
&lt;/body&gt;
&lt;/html&gt;
...
<span id="execution-results-GETapi-emergency--token-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-emergency--token-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-emergency--token-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-emergency--token-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-emergency--token-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-emergency--token-" data-method="GET"
      data-path="api/emergency/{token}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-emergency--token-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-emergency--token-"
                    onclick="tryItOut('GETapi-emergency--token-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-emergency--token-"
                    onclick="cancelTryOut('GETapi-emergency--token-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-emergency--token-"
            ...
            <b><code>api/emergency/{token}</code></b>
        </p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-emergency--token-"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-emergency--token-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="token"                data-endpoint="GETapi-emergency--token-"
               value="consequatur"
               data-component="url">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/test" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/test"
);
...
<div class="bash-example">
    ...
    "https://medical-system.test/api/register" \
    --header "Content-Type: application/json" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://medical-system.test/api/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/profile" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/profile"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://medical-system.test/api/patients" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "name=vmqeopfuudtdsufvyvddq"\
    --form "age=17"\
    --form "medical_history=consequatur"\
    --form "blood_group=mqeopfuud"\
    --form "phone=tdsufvyvddqamniih"\
    --form "address=consequatur"\
    --form "condition=consequatur"\
    --form "condition_status=consequatur"\
    --form "allergies=consequatur"\
    --form "emergency_contact_name=mqeopfuudtdsufvyvddqa"\
    --form "emergency_contact_phone=mniihfqcoynlazghd"\
    --form "medical_conditions=consequatur"\
    --form "image=@C:\Users\user\AppData\Local\Temp\phpAA7D.tmp" </code></pre></div>
...
body.append('age', '17');
body.append('medical_history', 'consequatur');
body.append('blood_group', 'mqeopfuud');
body.append('phone', 'tdsufvyvddqamniih');
body.append('address', 'consequatur');
body.append('condition', 'consequatur');
body.append('condition_status', 'consequatur');
body.append('allergies', 'consequatur');
body.append('emergency_contact_name', 'mqeopfuudtdsufvyvddqa');
body.append('emergency_contact_phone', 'mniihfqcoynlazghd');
body.append('medical_conditions', 'consequatur');
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="medical_history"                data-endpoint="POSTapi-patients"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="blood_group"                data-endpoint="POSTapi-patients"
               value="mqeopfuud"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="condition"                data-endpoint="POSTapi-patients"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>condition_status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="condition_status"                data-endpoint="POSTapi-patients"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="emergency_contact_name"                data-endpoint="POSTapi-patients"
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="emergency_contact_phone"                data-endpoint="POSTapi-patients"
...
<p>Must not be greater than 20 characters. Example: <code>mniihfqcoynlazghd</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>medical_conditions</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="medical_conditions"                data-endpoint="POSTapi-patients"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="POSTapi-patients"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\user\AppData\Local\Temp\phpAA7D.tmp</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/patients" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/patients/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/patients/1"
);
...
<div class="bash-example">
    ...
    --form "emergency_contact_phone=mniihfqcoynlazghd"\
    --form "medical_conditions=consequatur"\
    --form "image=@C:\Users\user\AppData\Local\Temp\phpAA9D.tmp" </code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="age"                data-endpoint="PUTapi-patients--id-"
               value="17"
               data-component="body">
    <br>
<p>Example: <code>17</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="medical_history"                data-endpoint="PUTapi-patients--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="blood_group"                data-endpoint="PUTapi-patients--id-"
               value="mqeopfuud"
               data-component="body">
    <br>
<p>Must not be greater than 10 characters. Example: <code>mqeopfuud</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="condition"                data-endpoint="PUTapi-patients--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="condition_status"                data-endpoint="PUTapi-patients--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="emergency_contact_name"                data-endpoint="PUTapi-patients--id-"
               value="mqeopfuudtdsufvyvddqa"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="emergency_contact_phone"                data-endpoint="PUTapi-patients--id-"
               value="mniihfqcoynlazghd"
               data-component="body">
    <br>
<p>Must not be greater than 20 characters. Example: <code>mniihfqcoynlazghd</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="medical_conditions"                data-endpoint="PUTapi-patients--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="PUTapi-patients--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\user\AppData\Local\Temp\phpAA9D.tmp</code></p>
        </div>
        </form>
...
<p>The ID of the patient. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-doctor-prescriptions">GET api/doctor/prescriptions</h2>
...
<span id="example-requests-GETapi-doctor-prescriptions">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/doctor/prescriptions" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/doctor/prescriptions"
);
...
<span id="example-responses-GETapi-doctor-prescriptions">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-doctor-prescriptions" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-doctor-prescriptions"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-doctor-prescriptions"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-doctor-prescriptions" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-doctor-prescriptions">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-doctor-prescriptions" data-method="GET"
      data-path="api/doctor/prescriptions"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-doctor-prescriptions', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-doctor-prescriptions"
                    onclick="tryItOut('GETapi-doctor-prescriptions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-doctor-prescriptions"
                    onclick="cancelTryOut('GETapi-doctor-prescriptions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-doctor-prescriptions"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/doctor/prescriptions</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-doctor-prescriptions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-doctor-prescriptions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-doctor-prescriptions--patientId-">POST api/doctor/prescriptions/{patientId}</h2>
...
<span id="example-requests-POSTapi-doctor-prescriptions--patientId-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://medical-system.test/api/doctor/prescriptions/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"medications\": [
        {
            \"medicine_name\": \"consequatur\",
            \"dosage\": \"consequatur\",
            \"duration_days\": 45
        }
    ],
...
<span id="example-responses-POSTapi-doctor-prescriptions--patientId-">
</span>
<span id="execution-results-POSTapi-doctor-prescriptions--patientId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-doctor-prescriptions--patientId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-doctor-prescriptions--patientId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-doctor-prescriptions--patientId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-doctor-prescriptions--patientId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-doctor-prescriptions--patientId-" data-method="POST"
      data-path="api/doctor/prescriptions/{patientId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-doctor-prescriptions--patientId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-doctor-prescriptions--patientId-"
                    onclick="tryItOut('POSTapi-doctor-prescriptions--patientId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-doctor-prescriptions--patientId-"
                    onclick="cancelTryOut('POSTapi-doctor-prescriptions--patientId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-doctor-prescriptions--patientId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/doctor/prescriptions/{patientId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="patientId"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="consequatur"
               data-component="url">
    <br>
<p>Example: <code>consequatur</code></p>
...
<br>
                        ...
                        <b style="line-height: 2;"><code>medicine_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="medications.0.medicine_name"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="medications.0.dosage"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="medications.0.duration_days"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="45"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="notes"                data-endpoint="POSTapi-doctor-prescriptions--patientId-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-doctor-prescriptions--id-">GET api/doctor/prescriptions/{id}</h2>
...
<span id="example-requests-GETapi-doctor-prescriptions--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/doctor/prescriptions/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-doctor-prescriptions--id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-doctor-prescriptions--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-doctor-prescriptions--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-doctor-prescriptions--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-doctor-prescriptions--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-doctor-prescriptions--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-doctor-prescriptions--id-" data-method="GET"
      data-path="api/doctor/prescriptions/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-doctor-prescriptions--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-doctor-prescriptions--id-"
                    onclick="tryItOut('GETapi-doctor-prescriptions--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-doctor-prescriptions--id-"
                    onclick="cancelTryOut('GETapi-doctor-prescriptions--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-doctor-prescriptions--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/doctor/prescriptions/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-doctor-prescriptions--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-doctor-prescriptions--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-doctor-prescriptions--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the prescription. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-doctor-prescription-items--id-">DELETE api/doctor/prescription-items/{id}</h2>
...
<span id="example-requests-DELETEapi-doctor-prescription-items--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://medical-system.test/api/doctor/prescription-items/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-DELETEapi-doctor-prescription-items--id-">
</span>
<span id="execution-results-DELETEapi-doctor-prescription-items--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-doctor-prescription-items--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-doctor-prescription-items--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-doctor-prescription-items--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-doctor-prescription-items--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-doctor-prescription-items--id-" data-method="DELETE"
      data-path="api/doctor/prescription-items/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-doctor-prescription-items--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-doctor-prescription-items--id-"
                    onclick="tryItOut('DELETEapi-doctor-prescription-items--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-doctor-prescription-items--id-"
                    onclick="cancelTryOut('DELETEapi-doctor-prescription-items--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-doctor-prescription-items--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-red">DELETE</small>
            <b><code>api/doctor/prescription-items/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-doctor-prescription-items--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-doctor-prescription-items--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-doctor-prescription-items--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the prescription item. Example: <code>consequatur</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://medical-system.test/api/appointments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"patient_id\": \"consequatur\",
    \"appointment_date\": \"2106-07-28\",
    \"status\": \"Scheduled\",
    \"notes\": \"consequatur\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>today</code>. Example: <code>2106-07-28</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/appointments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/appointments/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/appointments/consequatur"
);
...
<p>The ID of the appointment. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-patients--patientId--notes">POST api/patients/{patientId}/notes</h2>
...
<span id="example-requests-POSTapi-patients--patientId--notes">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://medical-system.test/api/patients/1/notes" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"patient_id\": \"consequatur\",
...
<span id="example-responses-POSTapi-patients--patientId--notes">
</span>
<span id="execution-results-POSTapi-patients--patientId--notes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-patients--patientId--notes"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-patients--patientId--notes"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-patients--patientId--notes" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-patients--patientId--notes">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-patients--patientId--notes" data-method="POST"
      data-path="api/patients/{patientId}/notes"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-patients--patientId--notes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-patients--patientId--notes"
                    onclick="tryItOut('POSTapi-patients--patientId--notes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-patients--patientId--notes"
                    onclick="cancelTryOut('POSTapi-patients--patientId--notes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-patients--patientId--notes"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/patients/{patientId}/notes</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-patients--patientId--notes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-patients--patientId--notes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="patientId"                data-endpoint="POSTapi-patients--patientId--notes"
               value="1"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="patient_id"                data-endpoint="POSTapi-patients--patientId--notes"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the patients table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="POSTapi-patients--patientId--notes"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/payments" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/payments"
);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="patient_id"                data-endpoint="POSTapi-payments"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the patients table. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="appointment_id"                data-endpoint="POSTapi-payments"
               value="consequatur"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/payments/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/payments/consequatur"
);
...
<p>The ID of the payment. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-medications-search">GET api/medications/search</h2>
...
<span id="example-requests-GETapi-medications-search">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://medical-system.test/api/medications/search" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://medical-system.test/api/medications/search"
);
...
<span id="example-responses-GETapi-medications-search">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-medications-search" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-medications-search"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-medications-search"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-medications-search" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-medications-search">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-medications-search" data-method="GET"
      data-path="api/medications/search"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-medications-search', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-medications-search"
                    onclick="tryItOut('GETapi-medications-search');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-medications-search"
                    onclick="cancelTryOut('GETapi-medications-search');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-medications-search"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/medications/search</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-medications-search"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-medications-search"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
